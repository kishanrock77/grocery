...
export class ItemCard implements OnInit, OnDestroy, OnChanges {
  ...
  variantDetailsSubscription?: Subscription;

  addonsDetailsSubscription?: Subscription;
...
console.log('item card 2')
  ...
  ngOnDestroy() {
    ...
    this.addressSubscription?.unsubscribe();
    this.wishlistSubscription?.unsubscribe();
    this.variantDetailsSubscription?.unsubscribe();
    this.addonsDetailsSubscription?.unsubscribe();
  }
...
if(this.pendingtocallremovefromwishlistfuntion==true  ){
  ...
  fetchVariantDetails() {
    ...
    this.variantDetailsSubscription = this.http.post(
  ...
  fetchAddDetails() {
    ...
    this.addonsDetailsSubscription = this.http.post(
      this.baseUrl + '/item/multi-details',
      {
