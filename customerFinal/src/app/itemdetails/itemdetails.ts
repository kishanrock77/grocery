...
export class ItemDetails implements OnInit, OnDestroy {
  ...
  addonsSubscription?: Subscription;
  ...
  ngOnDestroy(): void {
    ...
    this.addonsSubscription?.unsubscribe();
  ...
  syncCart() {
    ...
    this.cartSubscription = this.common.cartUpdated$
      .pipe(takeUntil(this.destroy$))
      .subscribe(() => {
  ...
  getItemDetails() {
    ...
    this.itemDetailsSubscription = this.http.get(
  ...
  getRelatedItems() {
    ...
    this.relatedItemsSubscription = this.api.getLevel3CategoryItems({
  ...
  fetchVariants() {
    ...
    this.variantsSubscription = this.http.post(
  ...
  fetchAddons() {
    ...
    this.addonsSubscription = this.http.post(
