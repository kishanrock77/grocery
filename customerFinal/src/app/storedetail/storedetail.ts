...
storesDetailsSubscription?: Subscription;
...
ngOnDestroy(): void {
  ...
  this.storesDetailsSubscription?.unsubscribe();
...
this.routeParamsSubscription = this.route.params.subscribe(p => {
  ...
  getStoresDetails() {
    ...
    this.storesDetailsSubscription?.unsubscribe();
    this.storesDetailsSubscription = this.api.getStoresDetails(this.storeId).subscribe((res: any) => {
