...
export class Cartpage implements OnInit, OnDestroy {
  ...
  selectedAddressSubscription?: Subscription;
  ...
  loadWallet() {
    ...
    this.walletSubscription = this.http.post(
  ...
  async ngOnInit() {
    ...
    this.selectedAddressSubscription =
  ...
  getAreas() {
    ...
    this.areasSubscription = this.api.getAreas()
      .subscribe((res: any) => {
