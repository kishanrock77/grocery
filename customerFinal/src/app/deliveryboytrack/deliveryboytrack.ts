...
export class Deliveryboytrack implements OnDestroy {
  ...
  boyDetailsSubscription?: Subscription;
 ...
 this.getboyDetails();
  ...
  ngOnDestroy() {
    ...
    this.routeParamsSubscription?.unsubscribe();
    this.boyDetailsSubscription?.unsubscribe();
...
console.log("333");
    try {
      ...
      this.boyDetailsSubscription = this.api.getboyDetails(this.boyid
